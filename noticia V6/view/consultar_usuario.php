                ...
                <div class="card-body table-responsive">
                    <table class="table table-striped" id="tabela_dados">
                        ...
                        <tbody>
                            ...
                            {   
                                $value->nivelacesso = str_replace("1","Administrador",$value->nivelacesso);                             
                                $value->nivelacesso = str_replace("2","Usuário",$value->nivelacesso);                             
                                echo"<tr>
                                    <td>$value->nome</td>
                                    <td>$value->email</td>
                                    <td>$value->nivelacesso</td>
                                    <td>
                                        <a href='".URL."excluir-usuario/$value->idusuario' class='btn btn-danger btn-sm' onclick='return confirm(\"Deseja realmente excluir?\")'><i class='fa fa-trash'></i> Excluir</a>
                                        <a href='".URL."editar-usuario/$value->idusuario' class='btn btn-warning btn-sm' onclick='excluir()'><i class='fa fa-edit'></i> Editar</a>
                                    </td>
                                </tr>";
                            }
                            ?>
